export const LyricsCreatorURL =
  import.meta.env.VITE_LYRICS_CREATOR_URL ||
  "https://allape.github.io/React-Lyrics/";

export const LyricsCreatorDocURL =
  import.meta.env.VITE_LYRICS_CREATOR_DOC_URL ||
